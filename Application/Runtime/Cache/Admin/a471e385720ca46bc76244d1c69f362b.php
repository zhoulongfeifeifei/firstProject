<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/System/department">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="<?php echo $per_page; ?>" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/System/department" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/System/add_department" target="dialog" width="900" height="400"mask="true" maxable="false" ><span>新建部门</span></a></li>
		</ul>
	</div>
	<div layoutH="92">
	<?php }else{?>
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center" nowrap="nowrap">
					...
					<a title="编辑" style="color: blue;" target="dialog" mask="true" class="btnEdit" rel="edit_department"  width="900" height="400" href="/System/edit_department?did=<?php echo $item['id'];?>">编辑</a>&nbsp&nbsp
					<?php }?>
					<?php if(checkPermission('del_department')){?>
					<a title="删除" style="color:blue;" target="ajaxTodo" class="btnDel" href="/System/del_department?did=<?php echo $item['id'];?>">删除</a>
					<?php }?>
				</td>
			</tr>
