<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/WechatUsers/index">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/WechatUsers/index" method="post">
	<div class="searchBar">
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center" nowrap="nowrap">
					...
					<a title="会话" style="color: blue;" target="dialog" mask="true" class="btnAssign infoBtn" rel="revert_msg"  width="700" height="500" href="/WechatMessage/revert_msg?openid=<?php echo $item['openid'];?>">编辑</a>&nbsp&nbsp
