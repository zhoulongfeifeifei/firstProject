...
<div class="pageContent">
	...
	<form method="post" action="/Wechat/add_menu" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone);">
