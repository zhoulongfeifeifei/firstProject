<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/System/employee">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="<?php echo $per_page; ?>" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/System/employee" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/System/add_employee" target="dialog" width="600" height="300"mask="true" maxable="false" ><span>新建人员</span></a></li>
		</ul>
	</div>
	<div layoutH="92">
	<?php }else{?>
	...
	<table class="table" width="100%">
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center">
					<a title="添加权限" href="/System/add_permission?id=<?php echo $item['id'];?>" target="dialog" class="btnAdd" rel="add_employee_permission" width="700" height="400">添加权限</a>
				</td>
				<td class="center" nowrap="nowrap">
					<?php if(checkPermission('edit_employee')){?>
					<a title="编辑" style="color: blue;" target="dialog" mask="true" class="btnEdit" rel="edit_employee"  width="600" height="300" href="/System/edit_employee?id=<?php echo $item['id'];?>">编辑</a>&nbsp&nbsp
					<?php }?>
					<?php if(checkPermission('del_employee')){?>
					<a title="删除" style="color:blue;" target="ajaxTodo" class="btnDel" href="/System/del_employee?id=<?php echo $item['id'];?>">删除</a>
					<?php }?>
				</td>
			</tr>
