<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/admin/Subject">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/admin/Subject/add_subject" target="dialog" width="600" height="250"mask="true" maxable="false" ><span>新建课程</span></a></li>
		</ul>
	</div>
	<div layoutH="55">
	<?php }else{?>
