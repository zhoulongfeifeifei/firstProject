<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/admin/Users/timetable_lists">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="<?php echo $per_page; ?>" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/Users/timetable_lists" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<?php if(checkPermission('add_timetable')){?>
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/admin/Course/add_timetable" target="dialog" width="900" height="500"mask="true" maxable="false" ><span>新建课时</span></a></li>
		</ul>
	</div>
	<div layoutH="92">
	<?php }else{?>
	...
	<table class="table" width="100%">
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center">
					<?php  if($item['type']==1){ echo '学生'; }else if($item['type']==2){ echo '前台'; }else if($item['type']==3){ echo '老师'; }else if($item['type']==4){ echo '老板'; } ?>
				</td>
				...
				<?php if(checkPermission('timetable_lists')){?>
				<td class="center">
					<a title="课程安排" class="btnAdd" style="color: blue;" target="navTab" mask="true" rel="timetable_lists"  width="800" height="400" href="/admin/Users/timetable_lists?id=<?php echo $item['id'];?>">
					课程安排
					</a>
				</td>
				<?php }else{?>
