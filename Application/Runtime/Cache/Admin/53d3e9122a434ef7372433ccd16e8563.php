<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/admin/Agency/agency_users_lists?ag_id=<?php echo I('get.ag_id');?>">
	...
	<table class="table" width="100%">
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center">
					<?php  switch($item['user_type']){ case 1: echo '学生'; break; case 2: echo '前台'; break; case 3: echo '老师'; break; case 4: echo '老板'; break; default : echo '未知'; break; } ?>
				</td>
