<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/WechatMessage/revert_lists">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/WechatMessage/revert_lists" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/WechatMessage/add_revert" target="dialog" width="850" height="400"mask="true" maxable="false" ><span>添加自动回复</span></a></li>
		</ul>
	</div>
	<div layoutH="65">
	<?php }else{?>
	...
	<table class="table" width="100%">
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center">
					<?php  switch($item['receive_type']){ case 0: echo '关键词（文本）'; break; case 1: echo "关注"; break; case 2: echo "图片"; break; case 3: echo "语音"; break; case 4: echo "视频"; break; case 5: echo '小视频'; break; case 6: echo "地理位置"; break; case 7: echo '链接'; break; } ?>
				</td>
				<td class="center">
					<?php  switch($item['revert_type']){ case 1: echo "文本"; break; case 2: echo "图片"; break; case 3: echo "语音"; break; case 4: echo "视频"; break; case 5: echo '音乐'; break; case 6: echo "图文"; break; } ?>
				</td>
				...
				<td class="center" nowrap="nowrap">
					...
					<a title="编辑" style="color: blue;" target="dialog" mask="true" class="btnEdit" rel="edit_revert"  width="850" height="400" href="/WechatMessage/edit_revert?id=<?php echo $item['id'];?>">编辑</a>&nbsp&nbsp
					<?php }?>
					<?php if(checkPermission('del_revert')){?>
					<a title="删除" style="color:blue;" target="ajaxTodo" class="btnDel" href="/WechatMessage/del_revert?id=<?php echo $item['id'];?>">删除</a>
					<?php }?>
				</td>
			</tr>
