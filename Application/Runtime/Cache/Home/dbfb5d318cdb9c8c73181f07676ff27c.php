...
<body>
	...
	<ul class="timet">
		<li class="timet-li1"><img src="/Static/images/home/Kb_backoff.png" alt=""></li>
		<li class="timet-li2">2016-11-14~2016-11-20</li>
		<li class="timet-li1"><img src="/Static/images/home/Kb_forward.png" alt=""></li>
	</ul>
				...
				<ul class="kebiao-list">
					...
					<li class="kebiao-li kebiao-li2">
						<ul class="kebiao-li-second">
							<li id="kebiao-li-first" class="kebiao-li-first">周四 11/17</li>
