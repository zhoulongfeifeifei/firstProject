 ...
 <div class="zezhao2"></div>
  ...
  <div class="course">
    ...
    <div class="has_course">
    	<p></p>
    	<ul class="has-course-list">
    		<li>老师：Cindy</li>
    		<li><label for="">机构：<input type="text" placeholder="请输入机构(非必填)"></label></li>
    		<li><label for="">课程：<input type="text" placeholder="请输入学习课程(非必填)"></label></li>
    		<li><label for="">学生：<input type="text" placeholder="请输入姓名(非必填)"></label></li>
    		<li>上课时间：周三 10:00-10:45</li>
    	</ul>
    	<div class="has-course-btn">
    		<button class="has-course-cancel">取消</button>
    		<button class="has-course-do">确认有课</button>
    	</div>
    </div>
</body>
