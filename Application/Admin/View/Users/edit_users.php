...
<div class="pageContent">
	...
	<form method="post" action="/admin/Users/edit_users?id=<?php echo I('get.id');?>" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="42">
			...
			<div class="unit">
				<label>电话：</label>
				<input type="text" name="mobile" size="30" value="<?php echo $info['mobile']?>" minlength="2" placeholder="请输入电话" maxlength="20" class="required tel" />
			</div>
			<div class="unit">
				<label>性别：</label>
				<select name="sex">
			...
			<div class="unit">
				...
				<select name="type">
					<option value="0">请选择</option>
					<option value="1" <?php echo $info['type']==1 ? 'selected':'';?>>学生</option>
					<option value="2" <?php echo $info['type']==2 ? 'selected': '';?>>前台</option>
					<option value="3" <?php echo $info['type']==3 ? 'selected': '';?>>老师</option>
					<option value="4" <?php echo $info['type']==4 ? 'selected': '';?>>老板</option>
				</select>
			</div>
			<div class="unit">
				<label>状态：</label>
