...
<div class="pageContent">
	...
	<form method="post" action="/admin/Course/add_course" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone);">
			...
			<div class="unit">
				...
				<select name="fid" id="parent_course">
					<option value="0">请选择</option>
  					<option value="-1">一级课程</option>
  					<?php foreach($lists as $items){?>
  						<option  value="<?php echo $items['id'];?>" ><?php echo $items['html'].$items['name'];?></option>
  					<?php }?>
   				</select>
			</div>
			<div class="unit">
