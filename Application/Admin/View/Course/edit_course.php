...
<div class="pageContent">
	...
	<form method="post" action="/admin/Course/edit_course?id=<?php echo I('get.id',0,'intval');?>" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone);">
				...
				<select name="fid" id="parent_course">
					<option value="0">请选择</option>
  					...
  					<?php foreach($lists as $items){?>
  						<option  <?php echo $info['fid']==$items['id'] ? 'selected' : '' ;?> value="<?php echo $items['id'];?>" ><?php echo $items['html'].$items['name'];?></option>
  					<?php }?>
   				</select>
			</div>
			<div class="unit">
