<form id="pagerForm" method="post" action="/admin/WechatMessage/wechat_keywords">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="<?php echo $per_page; ?>" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/WechatMessage/wechat_keywords" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/admin/WechatMessage/add_keywords" target="dialog" width="600" height="200"mask="true" maxable="false" ><span>添加关键词</span></a></li>
		</ul>
	</div>
	<div layoutH="65">
	<?php }else{?>
		...
		<tbody>
			...
			<tr target="sid_user" rel="<?php echo $item['id'];?>">
				...
				<td class="center" nowrap="nowrap">
					...
					<a title="编辑" style="color: blue;" target="dialog" mask="true" class="btnEdit" rel="edit_keywords"  width="600" height="200" href="/admin/WechatMessage/edit_keywords?id=<?php echo $item['id'];?>">编辑</a>&nbsp&nbsp
					<?php }?>
					<?php if(checkPermission('del_keywords')){?>
					<a title="删除" style="color:blue;" target="ajaxTodo" class="btnDel" href="/admin/WechatMessage/del_keywords?id=<?php echo $item['id'];?>">删除</a>
					<?php }?>
				</td>
			</tr>
